...
export default withTable(TableDemo);`,lang:"js"})))))});t.default=a=>{var E=e.a.useContext(n.context),F=E.demos;return e.a.useEffect(()=>{var l;a!=null&&(l=a.location)!==null&&l!==void 0&&l.hash&&n.AnchorLink.scrollToAnchor(decodeURIComponent(a.location.hash.slice(1)))},[]),e.a.createElement(o,{demos:F})}}}]);
